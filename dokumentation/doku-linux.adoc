...
- `Storage=persistent`: Logging auf der Platee, die Datei `/var/log/jounal` wird erstellt falls nicht vorhanden
...
- `jounalctl _UUID=1000`  Einträge des Nutzers mit der UID 1000
